...
const Filter = ({ value, onChange, placeholder = "Filter by week period" }: FilterProps) => {
    ...
    return (
        <div className="relative right-9 flex justify-end h-11 w-full text-xs md:text-sm">
            <TbFilter
            className="inline-block mr-1 text-orange-600 text-4xl cursor-pointer mt-1"
